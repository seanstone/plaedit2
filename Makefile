...
EMFLAGS += -s WASM=1 -s NO_EXIT_RUNTIME=1 -s ALLOW_MEMORY_GROWTH=1 -s USE_GLFW=3 -s USE_WEBGL2=1 -s FULL_ES2=1 -s FULL_ES3=1 --preload-file $(PWD)/glsl@/glsl --preload-file $(PWD)/textures@/textures
